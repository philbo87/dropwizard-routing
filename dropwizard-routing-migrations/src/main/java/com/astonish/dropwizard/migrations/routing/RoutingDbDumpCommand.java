...
public class RoutingDbDumpCommand<T extends Configuration> extends AbstractRoutingLiquibaseCommand<T> {
    public RoutingDbDumpCommand(RouteCapableDatabaseConfiguration<T> strategy, Class<T> configurationClass) {
