...
public class RoutingDbRollbackCommand<T extends Configuration> extends AbstractRoutingLiquibaseCommand<T> {
    public RoutingDbRollbackCommand(RouteCapableDatabaseConfiguration<T> strategy, Class<T> configurationClass) {
    ...
    public void run(Namespace namespace, Liquibase liquibase) throws Exception {
        ...
        if (((count == null) && (tag == null) && (date == null))
                || (((count != null) && (tag != null)) || ((count != null) && (date != null)) || ((tag != null) && (date != null)))) {
