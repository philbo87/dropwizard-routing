...
public class RouteCapableHibernateBundleTest {
    ...
    private final RouteCapableSessionFactoryFactory factory = mock(RouteCapableSessionFactoryFactory.class);
    private final Configuration configuration = mock(Configuration.class);
    private final HealthCheckRegistry healthChecks = mock(HealthCheckRegistry.class);
    private final JerseyEnvironment jerseyEnvironment = mock(JerseyEnvironment.class);
    private final Environment environment = mock(Environment.class);
    private final RouteCapableHibernateBundle<Configuration> bundle = new RouteCapableHibernateBundle<Configuration>(
            entities, factory) {
        @Override
    ...
    public void registersATransactionalAdapter() throws Exception {
        ...
        final ArgumentCaptor<RouteCapableUnitOfWorkResourceMethodDispatchAdapter> captor = ArgumentCaptor
                .forClass(RouteCapableUnitOfWorkResourceMethodDispatchAdapter.class);
