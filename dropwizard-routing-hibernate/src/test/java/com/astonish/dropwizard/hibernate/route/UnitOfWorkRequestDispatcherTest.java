...
public class UnitOfWorkRequestDispatcherTest {
    ...
    private final RouteCapableUnitOfWorkRequestDispatcher dispatcher = new RouteCapableUnitOfWorkRequestDispatcher(
            unitOfWork, underlying, ImmutableMap.<Optional<String>, SessionFactory> builder()
    ...
    public void routable() {
        ...
        final RouteCapableUnitOfWorkRequestDispatcher routableRequestDispatcher = new RouteCapableUnitOfWorkRequestDispatcher(
                unitOfWork, underlying, bldr.build());

        when(requestContext.getHeaderValue(RouteCapableUnitOfWorkRequestDispatcher.ROUTE_KEY_HEADER_NAME)).thenReturn(
                "route");
